            ...
            $('form').ajaxForm({
                success: function(data){
                    if(data.resultCode=='success'){
                        console.log("data.resultCode 1 >>> "+data.resultCode);
                        alert(data.resultMessage);
                        location.href = "../../../..";
                    } else {
                        console.log("data.resultCode 2 >>> "+data.resultCode);
                        alert(data.resultMessage);
                        //location.href = "/";
                    }
                }
...
<div class="login_wrap">
	<div class="inner">
		...
		<div class="login_box">
			<form id="login" action="/static/rest/selectUser" method="post">
				<ul>
				...
				<p class="login_btn"><a class="loginSubmit" style="cursor:pointer">Search my ID</a></p>

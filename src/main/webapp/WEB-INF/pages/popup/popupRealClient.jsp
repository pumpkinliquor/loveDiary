...
<script>
    ...
    $(document).ready(function(){
        ...
        colData.push({ label:'고객코드',name:'iclCompanyCode',index:'ICL_COMPANY_CODE',classes:'celltc',width:'150px'});
        colData.push({ label:'고객명',name:'iclCompanyName',index:'ICL_COMPANY_NAME',classes:'celltl',width:250});
        colData.push({ label:'법인명',name:'iclName',index:'ICL_NAME',classes:'celltc',hidden:true});
        colData.push({ label:'사업자번호',name:'iclBusinessNum',index:'ICL_BUSINESS_NUM',classes:'celltc',width:'150px'});
        colData.push({ label:'사업장소재지',name:'iclBusinessLocation',index:'ICL_BUSINESS_LOCATION',width:250,classes:'celltl',hidden:true});
        colData.push({ label:'법인번호',name:'iclCorporationNum',index:'ICL_CORPORATION_NUM',classes:'celltc',width:'150px'});
        ...
        lgUI.grid.popupGrid = lgUI.grid.makeGrid('popupGridElement',colData,'/rest/client/clientList',{},{'iclGubun':'C'},{onSelectRow:lgUI.event.gridPopupClick});
...
<div id="plusPopUpTabs" class="inner">
    <ul class="addTab">
        <li class="select"><a href="#tabs-grid" class="pageTitle">고객 목록</a></li>
    </ul>

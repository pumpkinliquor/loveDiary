...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	makePopupURL : function(){
		...
		// var sPopupUrl = "quick_photo_uploader/popup/imgUploadForm.html";
		// var sPopupUrl = "quick_photo_uploader/popup/imgUploadForm.jsp?id=";
		return sPopupUrl;
	},
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){
				...
				aPhotoInfo = {
				    ...
				    sOriginalImageURL : htData.sFileURL.replace(/↵/ig,'').replace(/\n/g,'').replace(/\r/g,''),
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" class="editorImage">';

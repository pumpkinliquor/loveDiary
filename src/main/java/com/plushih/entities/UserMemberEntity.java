...
public class UserMemberEntity extends PlusEntity implements Serializable {
	...
	public void setSafBbs(String safBbs) {
		this.safBbs = safBbs;
	}
	...
	public String toString() {
		return "UserMemberEntity [memId=" + memId + ", memUserid=" + memUserid + ", memEmail=" + memEmail + ", memPassword=" + memPassword + ", memUsername=" + memUsername + ", memNickname=" + memNickname + ", memLevel=" + memLevel + ", memPoint=" + memPoint + ", memHomepage=" + memHomepage + ", memPhone=" + memPhone + ", memBirthday=" + memBirthday + ", memSex=" + memSex + ", memZipcode=" + memZipcode + ", memAddress1=" + memAddress1 + ", memAddress2=" + memAddress2 + ", memAddress3=" + memAddress3 + ", memAddress4=" + memAddress4 + ", memReceiveEmail=" + memReceiveEmail + ", memUseNote=" + memUseNote + ", memReceiveSms=" + memReceiveSms + ", memOpenProfile=" + memOpenProfile + ", memDenied=" + memDenied + ", memEmailCert=" + memEmailCert + ", memRegisterDatetime=" + memRegisterDatetime + ", memRegisterIp=" + memRegisterIp + ", memLastloginDatetime=" + memLastloginDatetime + ", memLastloginIp=" + memLastloginIp + ", memIsAdmin=" + memIsAdmin + ", memProfileContent=" + memProfileContent + ", memAdminmemo=" + memAdminmemo + ", memFollowing=" + memFollowing + ", memFollowed=" + memFollowed + ", memIcon=" + memIcon + ", memPhoto=" + memPhoto + ", memClass=" + memClass + ", memGrade=" + memGrade + ", memSubId=" + memSubId + ", memPasswordEnc=" + memPasswordEnc + ", mtaTermsOfService=" + mtaTermsOfService + ", mtaPrivacyPolicy=" + mtaPrivacyPolicy + ", mtaMarketing=" + mtaMarketing + ", mtaRegisterDatatime=" + mtaRegisterDatatime + ", memJoinChannel=" + memJoinChannel + ", memStatus=" + memStatus + ", loginStateCode=" + loginStateCode + ", memTempId=" + memTempId + ", memFurGroup=" + memFurGroup + ", memFurYn=" + memFurYn + ", memConYn=" + memConYn + ", aigoAlarmMkt=" + aigoAlarmMkt + ", aigoAlarmLearn=" + aigoAlarmLearn + ", aigoAlarmNight=" + aigoAlarmNight + ", safSeq=" + safSeq + ", aigoAlarmDate=" + aigoAlarmDate + "]";
	}

...
import com.plushih.entities.Key;
import com.plushih.entities.Keys;
import com.plushih.entities.Payload;
...
public class AppleUtils {
     ...
     * @return
     */
    public TokenResponse validateAuthorizationGrantCode(String client_secret, String code) throws Exception{
     ...
     * @throws Exception
     */
    public TokenResponse validateAnExistingRefreshToken(String client_secret, String refresh_token) throws Exception {
     ...
     * @return
     */
    private TokenResponse getTokenResponse(Map<String, String> tokenRequest) throws Exception {

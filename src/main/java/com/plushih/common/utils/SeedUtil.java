...
public class SeedUtil {
  ...
  private static byte pbUserKey[]   = {0x64, 0x69, 0x67, 0x69, 0x73, 0x65, 0x65, 0x64,
                                       0x65, 0x6e, 0x63, 0x00, 0x23, 0x20, 0x20, 0x00,
                                       0x00, 0x20, 0x20, 0x51, 0x17, 0x65, 0x65, 0x64,
                                       0x73, 0x65, 0x65, 0x64, 0x73, 0x25, 0x65, 0x64,
                                       0x03, 0x12, 0x04, 0x11};
  ...
  private static int GetB0(final int A) { return (0x000000ff & A); }

  private static int GetB1(final int A) { return (0x000000ff & (A >>> 8)); }

  private static int GetB2(final int A) { return (0x000000ff & (A >>> 16)); }

  private static int GetB3(final int A) { return (0x000000ff & (A >>> 24)); }
  ...
  private static void SeedEncrypt(
    final byte pbData[],                    // [in] data to be encrypted
  ...
  private static void SeedDecrypt(
    final byte pbData[],                    // [in] encrypted data

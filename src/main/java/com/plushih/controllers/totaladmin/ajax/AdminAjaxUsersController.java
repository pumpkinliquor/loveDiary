...
@Controller
@RequestMapping("totaladmin/ajax/users")
public class AdminAjaxUsersController extends AjaxCodeController {
    private static final Logger LOGGER = LoggerFactory.getLogger( AdminAjaxUsersController.class );

...
@Controller
@RequestMapping("totaladmin/ajax/menus")
public class AdminAjaxMenusController extends AjaxCodeController {
    private static final Logger LOGGER = LoggerFactory.getLogger( AdminAjaxMenusController.class );

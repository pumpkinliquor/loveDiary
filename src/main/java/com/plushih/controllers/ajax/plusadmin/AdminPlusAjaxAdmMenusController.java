...
@Controller
@RequestMapping("plusadmin/ajax/admmenus")
public class AdminPlusAjaxAdmMenusController extends AjaxCodeController {
    private static final Logger LOGGER = LoggerFactory.getLogger( AdminPlusAjaxAdmMenusController.class );

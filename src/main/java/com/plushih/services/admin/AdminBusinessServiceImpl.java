...
public class AdminBusinessServiceImpl extends CiServiceImpl implements AdminBusinessService {
    ...
    public List<BusinessInfoEntity> getBusinessInfoList(plusActiveRecord dbEntity) throws Exception {
        ...
        dbEntity.select("bi.bi_seq" +
                ...
                ", bi.bi_etc" +
                ", bi.bi_is_del" +
                ", DATE_FORMAT(bi_start_date,'%Y-%m-%d') AS bi_start_date" +
                ", DATE_FORMAT(bi_end_date,'%Y-%m-%d') AS bi_end_date" +
                ", DATE_FORMAT(bi_del_date,'%Y-%m-%d') AS bi_del_date" +

 ...
 * Created by 
 */
@Service("AigoLevelService")
public class AigoLevelServiceImpl extends CiServiceImpl implements AigoLevelService {
     ...
     */
    @Override
    public CommonResultEntity getLevelList(plusActiveRecord dbEntity) throws Exception {
     ...
     */
    @Override
    public Integer setLevelExcute(plusActiveRecord dbEntity, AigoLevelEntity aigoLevelEntity) throws Exception {
...
//                }
     ...
     */
    @Override
    public Integer setLevelDelete(plusActiveRecord dbEntity, AigoLevelEntity aigoLevelEntity) throws Exception {

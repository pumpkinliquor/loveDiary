 ...
 * Created by 
 */
@Service("AigoEvaluationService")
public class AigoEvaluationServiceImpl extends CiServiceImpl implements AigoEvaluationService {
     ...
     */
    @Override
    public CommonResultEntity getEvaluationList(plusActiveRecord dbEntity) throws Exception {

        List<Map<String,Object>> dataHashList = new ArrayList<Map<String,Object>>();
        dbEntity.select("bb.*");
        dbEntity.from("cb_aigo_Evaluation bb");
     ...
     */
    @Override
    public Integer setEvaluationExcute(plusActiveRecord dbEntity, AigoEvaluationEntity aigoEvaluationEntity) throws Exception {
        ...
        dbEntity.from("cb_aigo_Evaluation");
        try {
            _INDB(dbEntity);
...
//
//                }
                dbEntity.insert_id = aigoEvaluationEntity.getLevId();//bbsEntity.getBbSeq();
            }
     ...
     */
    @Override
    public Integer setEvaluationDelete(plusActiveRecord dbEntity, AigoEvaluationEntity aigoEvaluationEntity) throws Exception {
